<?php require 'tc-index-controller.php'; ?>
<!doctype html>
<html lang='en'>
...
<body>
    ...
    <form method='GET' action='tc-process.php'>
        ...
        <?php if ($showResults) { ?>
            ...
            <img src="images/Summer Tai Chi_July 17 2019_800 px.png" alt="Tai Chi Sword Practice" width="400" /> </p>
